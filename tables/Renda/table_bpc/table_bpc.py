...
import requests
import pandas as pd
# Adicionei update_chaves_municipios na importação
from utils.utils import add_values, get_ultimo_mes_ano, get_municipio_codmun6, update_chaves_municipios
...
def dataframe():
    ...
    # Executa fora do while, após todas as inserções terminarem
    # print("\nExecutando atualização de chaves e siglas (SQL)...")
