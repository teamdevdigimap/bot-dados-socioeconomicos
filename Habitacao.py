...
from tables.Habitação.tables_sem_acesso_agua_e_coleta_esgoto.tables_sem_acesso_agua_e_coleta_esgoto import run_saneamento_import
...
def habitacao_run():
    ...
    # try:
    #     # arquivo_csv = "C:/Users/matheus.souza/Downloads/acesso_agua_e_coleta_esgoto.csv"
    #     arquivo_csv = None
    #     ano = 2023 # Substitua pelo ano correto    
    #     print("\nIniciando tables_sem_acesso_agua_e_coleta_esgoto...\n")
    #     run_saneamento_import(arquivo_csv, ano)
    #     print("\nFinalizando tables_sem_acesso_agua_e_coleta_esgoto...\n")
    #     pass
    # except Exception as e:
    #     print(f"Erro na tabela tables_sem_acesso_agua_e_coleta_esgoto \n{e}")